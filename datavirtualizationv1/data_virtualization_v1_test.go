	...
	Describe(`AddDatasourceConnection(addDatasourceConnectionOptions *AddDatasourceConnectionOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke AddDatasourceConnection with error: Operation response processing error`, func() {
				...
				postDatasourceConnectionParametersPropertiesModel.AccessToken = core.StringPtr("ya29.Il-_")
				postDatasourceConnectionParametersPropertiesModel.AccountName = core.StringPtr("ibmdatastage.us-east-1")
				postDatasourceConnectionParametersPropertiesModel.APIKey = core.StringPtr("ApiKey-a31d60c5-0f7b-4995-a4ae-69bf09d3de50")
				postDatasourceConnectionParametersPropertiesModel.AuthType = core.StringPtr("Bearer Token")
				postDatasourceConnectionParametersPropertiesModel.ClientID = core.StringPtr("81571342315")
				postDatasourceConnectionParametersPropertiesModel.ClientSecret = core.StringPtr("uIn8rVyIRsd")
				postDatasourceConnectionParametersPropertiesModel.Collection = core.StringPtr("test_collection")
				postDatasourceConnectionParametersPropertiesModel.Credentials = core.StringPtr("-----BEGIN PRIVATE KEY-----")
				...
				postDatasourceConnectionParametersPropertiesModel.HTTPPath = core.StringPtr("cliservice")
				postDatasourceConnectionParametersPropertiesModel.JarUris = core.StringPtr("/v2/asset_files/dbdrivers/ngdbc.jar")
				postDatasourceConnectionParametersPropertiesModel.JdbcDriver = core.StringPtr("Snowflake")
				postDatasourceConnectionParametersPropertiesModel.JdbcURL = core.StringPtr("/v2/asset_files/dbdrivers/ngdbc.jar")
				...
				postDatasourceConnectionParametersPropertiesModel.ProjectID = core.StringPtr("housecanary-com")
				postDatasourceConnectionParametersPropertiesModel.Properties = core.StringPtr("key=value")
				postDatasourceConnectionParametersPropertiesModel.RefreshToken = core.StringPtr("1//06uwhP7_312g")
				postDatasourceConnectionParametersPropertiesModel.Role = core.StringPtr("SYSADMIN")
				postDatasourceConnectionParametersPropertiesModel.SapGatewayURL = core.StringPtr("https://sapes5.sapdevcenter.com")
				postDatasourceConnectionParametersPropertiesModel.Server = core.StringPtr("ol_informix1410")
				postDatasourceConnectionParametersPropertiesModel.ServiceName = core.StringPtr("pdborcl.fyre.ibm.com")
				postDatasourceConnectionParametersPropertiesModel.Sid = core.StringPtr("orcl")
				postDatasourceConnectionParametersPropertiesModel.Ssl = core.StringPtr("false")
				postDatasourceConnectionParametersPropertiesModel.SslCertificate = core.StringPtr("-----BEGIN CERTIFICATE-----")
				postDatasourceConnectionParametersPropertiesModel.SslCertificateHost = core.StringPtr("test.com")
				postDatasourceConnectionParametersPropertiesModel.SslCertificateValidation = core.StringPtr("false")
				postDatasourceConnectionParametersPropertiesModel.Username = core.StringPtr("db2inst1")
				postDatasourceConnectionParametersPropertiesModel.Warehouse = core.StringPtr("wdpcondev")
				...
				addDatasourceConnectionOptionsModel.AssetCategory = core.StringPtr("USER")
	...
	Describe(`Model constructor tests`, func() {
		Context(`Using a service client instance`, func() {
			...
			It(`Invoke NewAddDatasourceConnectionOptions successfully`, func() {
				...
				postDatasourceConnectionParametersPropertiesModel.Username = core.StringPtr("db2inst1")
				postDatasourceConnectionParametersPropertiesModel.Warehouse = core.StringPtr("wdpcondev")
				Expect(postDatasourceConnectionParametersPropertiesModel.AccessToken).To(Equal(core.StringPtr("ya29.Il-_")))
				Expect(postDatasourceConnectionParametersPropertiesModel.AccountName).To(Equal(core.StringPtr("ibmdatastage.us-east-1")))
				Expect(postDatasourceConnectionParametersPropertiesModel.APIKey).To(Equal(core.StringPtr("ApiKey-a31d60c5-0f7b-4995-a4ae-69bf09d3de50")))
				Expect(postDatasourceConnectionParametersPropertiesModel.AuthType).To(Equal(core.StringPtr("Bearer Token")))
				Expect(postDatasourceConnectionParametersPropertiesModel.ClientID).To(Equal(core.StringPtr("81571342315")))
				Expect(postDatasourceConnectionParametersPropertiesModel.ClientSecret).To(Equal(core.StringPtr("uIn8rVyIRsd")))
				Expect(postDatasourceConnectionParametersPropertiesModel.Collection).To(Equal(core.StringPtr("test_collection")))
				Expect(postDatasourceConnectionParametersPropertiesModel.Credentials).To(Equal(core.StringPtr("-----BEGIN PRIVATE KEY-----")))
				...
				Expect(postDatasourceConnectionParametersPropertiesModel.HTTPPath).To(Equal(core.StringPtr("cliservice")))
				Expect(postDatasourceConnectionParametersPropertiesModel.JarUris).To(Equal(core.StringPtr("/v2/asset_files/dbdrivers/ngdbc.jar")))
				Expect(postDatasourceConnectionParametersPropertiesModel.JdbcDriver).To(Equal(core.StringPtr("Snowflake")))
				Expect(postDatasourceConnectionParametersPropertiesModel.JdbcURL).To(Equal(core.StringPtr("/v2/asset_files/dbdrivers/ngdbc.jar")))
				...
				Expect(postDatasourceConnectionParametersPropertiesModel.ProjectID).To(Equal(core.StringPtr("housecanary-com")))
				Expect(postDatasourceConnectionParametersPropertiesModel.Properties).To(Equal(core.StringPtr("key=value")))
				Expect(postDatasourceConnectionParametersPropertiesModel.RefreshToken).To(Equal(core.StringPtr("1//06uwhP7_312g")))
				Expect(postDatasourceConnectionParametersPropertiesModel.Role).To(Equal(core.StringPtr("SYSADMIN")))
				Expect(postDatasourceConnectionParametersPropertiesModel.SapGatewayURL).To(Equal(core.StringPtr("https://sapes5.sapdevcenter.com")))
				Expect(postDatasourceConnectionParametersPropertiesModel.Server).To(Equal(core.StringPtr("ol_informix1410")))
				Expect(postDatasourceConnectionParametersPropertiesModel.ServiceName).To(Equal(core.StringPtr("pdborcl.fyre.ibm.com")))
				Expect(postDatasourceConnectionParametersPropertiesModel.Sid).To(Equal(core.StringPtr("orcl")))
				Expect(postDatasourceConnectionParametersPropertiesModel.Ssl).To(Equal(core.StringPtr("false")))
				Expect(postDatasourceConnectionParametersPropertiesModel.SslCertificate).To(Equal(core.StringPtr("-----BEGIN CERTIFICATE-----")))
				Expect(postDatasourceConnectionParametersPropertiesModel.SslCertificateHost).To(Equal(core.StringPtr("test.com")))
				Expect(postDatasourceConnectionParametersPropertiesModel.SslCertificateValidation).To(Equal(core.StringPtr("false")))
				Expect(postDatasourceConnectionParametersPropertiesModel.Username).To(Equal(core.StringPtr("db2inst1")))
				Expect(postDatasourceConnectionParametersPropertiesModel.Warehouse).To(Equal(core.StringPtr("wdpcondev")))
				...
				addDatasourceConnectionOptionsModel.SetAssetCategory("USER")
				...
				Expect(addDatasourceConnectionOptionsModel.AssetCategory).To(Equal(core.StringPtr("USER")))
